...
DEFAULT_TERMS = ['Import declaration', 'Standard mark', 'Value Added Tax']


def main() -> None:
    parser = argparse.ArgumentParser(description='Build an importer standards glossary.')
    ...
    result = builder.build_glossary(
        ...
        title='Importer Standards Glossary',
    )
    ...
    if args.output_dir:
        ...
        (output_dir / 'importer-standards-glossary.md').write_text(builder.to_markdown(result, localization='en'), encoding="utf-8")

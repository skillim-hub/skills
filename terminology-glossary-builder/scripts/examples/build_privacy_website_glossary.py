...
DEFAULT_TERMS = ['Privacy policy', 'Database registration or notice', 'Accessibility statement']


def main() -> None:
    parser = argparse.ArgumentParser(description='Build a website privacy glossary.')
    ...
    result = builder.build_glossary(
        ...
        title='Website Privacy Glossary',
    )
    ...
    if args.output_dir:
        ...
        (output_dir / 'privacy-website-glossary.md').write_text(builder.to_markdown(result, localization='en'), encoding="utf-8")

...
DEFAULT_TERMS = ['Consumer cancellation', 'Warranty certificate', 'Value Added Tax', 'Standard mark']


def main() -> None:
    parser = argparse.ArgumentParser(description='Build a retail consumer glossary.')
    ...
    result = builder.build_glossary(
        ...
        title='Retail Consumer Glossary',
    )
    ...
    if args.output_dir:
        ...
        (output_dir / 'retail-consumer-glossary.md').write_text(builder.to_markdown(result, localization='en'), encoding="utf-8")

...
DEFAULT_TERMS = ['Company extract', 'Private company', 'Prospectus']


def main() -> None:
    parser = argparse.ArgumentParser(description='Build and write a corporate glossary.')
    ...
    if args.output_dir:
        ...
        (output_dir / 'corporate-glossary.md').write_text(builder.to_markdown(result, localization='en'), encoding="utf-8")

...
def parse_args():
    ...
    parser.add_argument('--invoice-id', default=os.getenv('INVOICE_ID','SAMPLE-LINE-DISCOUNT'))
...
def main():
    args=parse_args()
    lines=[{'sku': 'DESIGN', 'description': 'Landing page design', 'quantity': '1', 'unit_price': '1800', 'vat_rate': '18%', 'discount_type': 'percent', 'discount_value': '7.5'}]

...
def parse_args():
    ...
    parser.add_argument('--invoice-id', default=os.getenv('INVOICE_ID','SAMPLE-INVOICE-DISCOUNT'))
...
def main():
    args=parse_args()
    lines=[{'sku': 'A', 'description': 'Monthly support', 'quantity': '1', 'unit_price': '900', 'vat_rate': '18%'}, {'sku': 'B', 'description': 'Setup', 'quantity': '1', 'unit_price': '300', 'vat_rate': '18%'}]
    invoice_discount=Discount.amount("120", "Commercial discount")

#!/usr/bin/env python3
"""Sensitive legal handoff example."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--name", default=os.getenv("LQB_NAME", "אורי"))
...
def main() -> None:
    ...
    lead = client.create_lead(message=os.getenv("LQB_MESSAGE", "פיטרו אותי היום ואני צריך עורך דין עכשיו"), phone=args.phone, name=args.name)

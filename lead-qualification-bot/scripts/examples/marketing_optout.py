...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--name", default=os.getenv("LQB_NAME", "מיכל"))
...
def main() -> None:
    ...
    lead = client.create_lead(message=os.getenv("LQB_MESSAGE", "הסרה"), phone=args.phone, name=args.name)

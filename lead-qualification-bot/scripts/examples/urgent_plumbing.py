...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--name", default=os.getenv("LQB_NAME", "דנה"))
...
def main() -> None:
    ...
    lead = client.create_lead(message=os.getenv("LQB_MESSAGE", "צריך תיקון נזילה היום בתל אביב תקציב 500 שח"), phone=args.phone, name=args.name)

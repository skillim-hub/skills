...
parser = argparse.ArgumentParser(description="Fetch a parcel through the async client.")
...
async def main() -> None:
    ...
    extract = await client.async_get_by_parcel(ParcelId(args.block, args.parcel, args.subparcel))

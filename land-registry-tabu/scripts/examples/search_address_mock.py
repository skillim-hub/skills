...
parser = build_parser("Run an address lookup and print normalized JSON.")
parser.add_argument("--city", default="Tel Aviv-Yafo")
parser.add_argument("--street", default="Example Street")
parser.add_argument("--house", default="10")
args = parser.parse_args()

client = build_client(args)
extract = client.search_by_address(city=args.city, street=args.street, house=args.house)

...
def main() -> None:
    ...
    lead = {
        "name": os.getenv("LEAD_ROUTER_NAME", "Marina"),
        "phone": os.getenv("LEAD_ROUTER_PHONE", "+972541112222"),
        "city": os.getenv("LEAD_ROUTER_CITY", "חיפה"),
        "message": os.getenv("LEAD_ROUTER_MESSAGE", "Устройство не работает, нужна помощь"),
        "channel": os.getenv("LEAD_ROUTER_CHANNEL", "web_form"),
    }

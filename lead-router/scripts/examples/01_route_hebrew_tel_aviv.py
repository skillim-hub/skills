...
def main() -> None:
    ...
    lead = {
        "name": os.getenv("LEAD_ROUTER_NAME", "דנה"),
        "phone": os.getenv("LEAD_ROUTER_PHONE", "052-1234567"),
        "message": os.getenv("LEAD_ROUTER_MESSAGE", "אשמח למחיר להתקנה בתל אביב"),
        "channel": os.getenv("LEAD_ROUTER_CHANNEL", "whatsapp"),
        "consent_marketing": os.getenv("LEAD_ROUTER_MARKETING_CONSENT", "false").lower() == "true",
    }

...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Assess a private clinic patient workflow.")
...
def main() -> None:
    ...
    payload = {'record_count': 12000, 'authorized_users': 9, 'sensitive_categories': ['health', 'national_id'], 'sector': 'clinic', 'purposes': ['treatment', 'billing', 'appointment reminders'], 'lawful_basis': 'legal_obligation', 'processors': ['appointment platform', 'billing provider'], 'retention_months': 120}
    payload["business_name"] = f'Private clinic patient system ({args.profile})'

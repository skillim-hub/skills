...
price = Decimal(os.getenv("CAR_LEASING_TAX_BENEFIT_ELECTRIC_PRICE_ILS", "220000"))
tax_rate = Decimal(os.getenv("CAR_LEASING_TAX_BENEFIT_MARGINAL_TAX_RATE", "0.47"))
result = client.calculate(VehicleInput(original_price_ils=price, category="electric", tax_year=tax_year, employee_marginal_tax_rate=tax_rate))

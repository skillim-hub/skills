...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description='Review cancellation terms for a consumer purchase.')
    parser.add_argument(
        "--env",

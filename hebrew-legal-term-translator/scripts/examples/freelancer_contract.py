...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description='Review a freelancer service agreement before signature.')
    parser.add_argument(
        "--env",

...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description='Review privacy wording for a customer list or website form.')
    parser.add_argument(
        "--env",

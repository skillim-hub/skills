...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description='Review a debt warning or enforcement notice.')
    parser.add_argument(
        "--env",

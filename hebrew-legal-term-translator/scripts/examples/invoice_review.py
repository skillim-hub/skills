...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description='Review invoice and payment documents for a small business.')
    parser.add_argument(
        "--env",

...
def build_inputs(env: str) -> TaxInputs:
    ...
    purchase_price = float(os.getenv("MAS_SHEVACH_PURCHASE_PRICE", "800000"))
    sale_price = float(os.getenv("MAS_SHEVACH_SALE_PRICE", "1500000"))
    payload = {
        "purchase_date": os.getenv("MAS_SHEVACH_PURCHASE_DATE", "2016-03-15"),
        "sale_date": os.getenv("MAS_SHEVACH_SALE_DATE", "2025-09-01"),
        "purchase_price": purchase_price,
        "sale_price": sale_price,
        "purchase_costs": float(os.getenv("MAS_SHEVACH_PURCHASE_COSTS", "45000")),
        "sale_costs": float(os.getenv("MAS_SHEVACH_SALE_COSTS", "40000")),
        "improvements": float(os.getenv("MAS_SHEVACH_IMPROVEMENTS", "200000")),
        "depreciation_claimed": float(os.getenv("MAS_SHEVACH_DEPRECIATION", "120000")),
        "ownership_share": float(os.getenv("MAS_SHEVACH_OWNERSHIP_SHARE", "1")),
        "property_type": os.getenv("MAS_SHEVACH_PROPERTY_TYPE", "commercial"),

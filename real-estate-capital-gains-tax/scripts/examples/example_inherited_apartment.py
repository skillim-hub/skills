...
def build_inputs(env: str) -> TaxInputs:
    ...
    purchase_price = float(os.getenv("MAS_SHEVACH_PURCHASE_PRICE", "650000"))
    sale_price = float(os.getenv("MAS_SHEVACH_SALE_PRICE", "2200000"))
    payload = {
        "purchase_date": os.getenv("MAS_SHEVACH_PURCHASE_DATE", "1999-04-10"),
        "sale_date": os.getenv("MAS_SHEVACH_SALE_DATE", "2025-02-20"),
        ...
        "ownership_share": float(os.getenv("MAS_SHEVACH_OWNERSHIP_SHARE", "0.5")),
        ...
        "tax_rate": tax_rate,
        "exemption_code": os.getenv("MAS_SHEVACH_EXEMPTION_CODE", "inherited_apartment"),

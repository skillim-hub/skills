...
def build_inputs(env: str) -> TaxInputs:
    ...
    sale_price = float(os.getenv("MAS_SHEVACH_SALE_PRICE", "2000000"))
    payload = {
        "purchase_date": os.getenv("MAS_SHEVACH_PURCHASE_DATE", "2010-01-01"),
    ...
    cpi_purchase = os.getenv("MAS_SHEVACH_CPI_PURCHASE", "80")
    cpi_sale = os.getenv("MAS_SHEVACH_CPI_SALE", "100")

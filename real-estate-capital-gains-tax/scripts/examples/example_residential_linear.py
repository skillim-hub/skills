...
def build_inputs(env: str) -> TaxInputs:
    ...
    purchase_price = float(os.getenv("MAS_SHEVACH_PURCHASE_PRICE", "1000000"))
    sale_price = float(os.getenv("MAS_SHEVACH_SALE_PRICE", "2400000"))
    payload = {
        "purchase_date": os.getenv("MAS_SHEVACH_PURCHASE_DATE", "2008-06-01"),
        "sale_date": os.getenv("MAS_SHEVACH_SALE_DATE", "2025-06-01"),
        "purchase_price": purchase_price,
        "sale_price": sale_price,
        "purchase_costs": float(os.getenv("MAS_SHEVACH_PURCHASE_COSTS", "50000")),
        "sale_costs": float(os.getenv("MAS_SHEVACH_SALE_COSTS", "60000")),
        "improvements": float(os.getenv("MAS_SHEVACH_IMPROVEMENTS", "150000")),
        ...
        "is_qualifying_residential_apartment": os.getenv("MAS_SHEVACH_QUALIFYING_RESIDENTIAL", "true").lower() in {"1", "true", "yes"},

...
def build_inputs(env: str) -> TaxInputs:
    ...
    purchase_price = float(os.getenv("MAS_SHEVACH_PURCHASE_PRICE", "1200000"))
    sale_price = float(os.getenv("MAS_SHEVACH_SALE_PRICE", "2100000"))
    payload = {
        "purchase_date": os.getenv("MAS_SHEVACH_PURCHASE_DATE", "2012-07-01"),
        "sale_date": os.getenv("MAS_SHEVACH_SALE_DATE", "2025-07-01"),
        ...
        "seller_residency": os.getenv("MAS_SHEVACH_SELLER_RESIDENCY", "foreign_resident"),

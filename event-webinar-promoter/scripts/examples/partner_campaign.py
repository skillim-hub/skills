...
def main() -> None:
    ...
    event["consent_status"] = "partner_owned"
    plan = client.plan(event)
    print(json.dumps({"environment": args.env, "channels": plan.recommended_channels, "utm_links": plan.utm_links}, ensure_ascii=False, indent=2))

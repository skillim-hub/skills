...
def main() -> None:
    ...
    request = build_request(
        hmo=os.getenv("HAB_HMO", "clalit"),
        service=os.getenv("HAB_SERVICE", "routine prescription renewal with family doctor"),
        city=os.getenv("HAB_CITY", "Tel Aviv"),
        date_from=os.getenv("HAB_DATE_FROM", "2026-07-01"),
        date_to=os.getenv("HAB_DATE_TO", "2026-07-14"),

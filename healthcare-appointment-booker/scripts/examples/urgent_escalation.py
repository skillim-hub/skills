...
def main() -> None:
    ...
    request = build_request(
        ...
        service=os.getenv("HAB_SERVICE", "cardiologist for chest pain and shortness of breath"),
        city=os.getenv("HAB_CITY", "Haifa"),
        ...
        referral_status=os.getenv("HAB_REFERRAL_STATUS", "unknown"),

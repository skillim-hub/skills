...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Child allowance family scenario")
...
def main() -> None:
    ...
    profile = ApplicantProfile.from_mapping({'age': 34, 'resident': True, 'children_count': 3, 'birth_dates': ['01/02/2013', '14/06/2018', '27/11/2022']})
    payload = {"scenario": "child_allowance_new_family", "environment": args.env, "result": checker.check_benefit("child_allowance", profile).to_dict()}
    if default_city:

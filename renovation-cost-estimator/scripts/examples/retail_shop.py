...
def main() -> None:
    ...
    project = {'project_name': 'Retail shop', 'city': 'Jerusalem', 'property_type': 'shop', 'area_sqm': 42, 'scope_level': 'retail_fitout', 'finish_level': 'premium', 'requires_business_license': True, 'signage': True, 'include_vat': False}

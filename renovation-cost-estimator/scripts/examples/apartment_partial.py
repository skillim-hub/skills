...
def main() -> None:
    ...
    project = {'project_name': '72 m² apartment', 'city': 'Ramat Gan', 'property_type': 'apartment', 'area_sqm': 72, 'scope_level': 'partial', 'finish_level': 'standard', 'bathrooms': 1, 'kitchens': 1}

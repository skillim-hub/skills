...
def main() -> None:
    ...
    project = {'project_name': 'Quote review', 'city': 'Ramat Gan', 'property_type': 'apartment', 'area_sqm': 80, 'scope_level': 'full', 'finish_level': 'standard', 'contractor_quote_total': 300000, 'contractor_quote_includes_vat': False}

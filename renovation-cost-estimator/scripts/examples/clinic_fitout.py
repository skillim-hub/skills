...
def main() -> None:
    ...
    project = {'project_name': 'Clinic fit-out', 'city': 'Tel Aviv', 'property_type': 'clinic', 'area_sqm': 38, 'scope_level': 'commercial_fitout', 'finish_level': 'standard', 'requires_business_license': True, 'commercial_public_access': True, 'include_vat': False}

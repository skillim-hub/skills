...
def main() -> None:
    ...
    project = {'project_name': 'Measured trades', 'city': 'Rishon LeZion', 'property_type': 'apartment', 'area_sqm': 80, 'scope_level': 'partial', 'finish_level': 'standard', 'line_items': [{'category': 'floor_tiling', 'quantity': 80}, {'category': 'electrical_point', 'quantity': 45}, {'category': 'paint', 'quantity': 220}]}
